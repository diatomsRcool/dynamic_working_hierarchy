...
in_file = open('termites.txt', 'r')
out_file = open('termites_1.txt', 'w')
...
out_file = open('termites_3.txt','w')

with open("termites.txt") as textfile1, open("termites_2.txt") as textfile2:
